...
total_faces = olivetti.data
print(total_faces.shape)
pca = PCA(400)
components = pca.fit_transform(total_faces)
...
# import pdb; pdb.set_trace()
pca80 = PCA(80)
components = pca80.fit_transform(total_faces)
recons = pca80.inverse_transform(components)
...
#######################################################################
plot_faces(recons[-25:],plot_label='recon',labels=range(25))
# Your code goes here:
# import pdb; pdb.set_trace()
